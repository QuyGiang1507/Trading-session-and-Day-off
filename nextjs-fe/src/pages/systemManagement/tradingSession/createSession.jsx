...
const CreateSession = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
        commodity: Yup.string().when("isGeneralSession", {
          is: false,
          then: Yup.string().required("Commidity mustn't be empty"),
        }),
        ...
        endTime: Yup.string().when("isGeneralSession", {
          ...
          then: 
            Yup
              .string()
              .required("End time mustn't be empty")
              .test("is-higher", "End time must be higher than Start time", function (endTime) {
                const startTime = this.resolve(Yup.ref("startTime"));
                if (!startTime || !endTime) return true; 
                return new Date(`01/01/2000 ${endTime}`) > new Date(`01/01/2000 ${startTime}`);
              }),
        }),
        ...
        preOpenEndTime: Yup.string().when("isGeneralSession", {
          ...
          then: 
            Yup
              .string()
              .required("Pre-Open time mustn't be empty")
              .test("is-higher", "End time must be higher than Start time", function (preOpenEndTime) {
                const preOpenStartTime = this.resolve(Yup.ref("preOpenStartTime"));
                if (!preOpenStartTime || !preOpenEndTime) return true; 
                return new Date(`01/01/2000 ${preOpenEndTime}`) > new Date(`01/01/2000 ${preOpenStartTime}`);
              }),
        }),
        ...
        openEndTime: Yup.string().when("isGeneralSession", {
          ...
          then: 
            Yup
              .string()
              .required("Open Time mustn't be empty")
              .test("is-higher", "End time must be higher than Start time", function (openEndTime) {
                const openStartTime = this.resolve(Yup.ref("openStartTime"));
                if (!openStartTime || !openEndTime) return true; 
                return new Date(`01/01/2000 ${openEndTime}`) > new Date(`01/01/2000 ${openStartTime}`);
              }),
        }),
        ...
        pauseEndTime: Yup.string().when("isGeneralSession", {
          ...
          then: 
            Yup
              .string()
              .required("Pause Time mustn't be empty")
              .test("is-higher", "End time must be higher than Start time", function (pauseEndTime) {
                const pauseStartTime = this.resolve(Yup.ref("pauseStartTime"));
                if (!pauseStartTime || !pauseEndTime) return true; 
                return new Date(`01/01/2000 ${pauseEndTime}`) > new Date(`01/01/2000 ${pauseStartTime}`);
              }),
        }),
        ...
        closeEndTime: Yup.string().when("isGeneralSession", {
          ...
          then: 
            Yup
              .string()
              .required("Close Time mustn't be empty")
              .test("is-higher", "End time must be higher than Start time", function (closeEndTime) {
                const closeStartTime = this.resolve(Yup.ref("closeStartTime"));
                if (!closeStartTime || !closeEndTime) return true; 
                return new Date(`01/01/2000 ${closeEndTime}`) > new Date(`01/01/2000 ${closeStartTime}`);
              }),
        }),
        ...
        maintenanceEndTime: Yup.string().when("isGeneralSession", {
          ...
          then: 
            Yup
              .string()
              .required("Maintenance Time mustn't be empt")
              .test("is-higher", "End time must be higher than Start time", function (maintenanceEndTime) {
                const maintenanceStartTime = this.resolve(Yup.ref("maintenanceStartTime"));
                if (!maintenanceStartTime || !maintenanceEndTime) return true; 
                return new Date(`01/01/2000 ${maintenanceEndTime}`) > new Date(`01/01/2000 ${maintenanceStartTime}`);
              }),
        }),
    }),
      ...
      await tradingSessionService
        ...
        .then((res) => {
          if (res.status === 0) {
            ...
            toast(
              "Trading session was created and waiting for approval from admin",
              { className: "bg-success text-white" },
            );
            router.push("/systemManagement/tradingSession");
          }
        });
    },
  });
  ...
  document.title = "Create Trading Session";
                        ...
                        <>
                          ...
                          <Col lg={6}>
                            <div className="mb-3">
                              ...
                              {formik.touched.maintenanceEndTime && formik.errors.maintenanceEndTime ? (
                                <FormFeedback type="invalid">
                                  {formik.errors.maintenanceEndTime}
                                </FormFeedback>
                              ) : null}
                            </div>
                          </Col>
